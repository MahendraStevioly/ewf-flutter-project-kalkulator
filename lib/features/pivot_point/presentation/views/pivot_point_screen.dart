...
class _PivotPointViewState extends State<_PivotPointView>
  ...
  Widget _buildManualInputs(BuildContext context) {
    return Column(
      children: [
        _inputField(context: context, label: 'HIGH', hint: '', controller: highController),
        const SizedBox(height: 20),
        _inputField(context: context, label: 'LOW', hint: '', controller: lowController),
        const SizedBox(height: 20),
        _inputField(context: context, label: 'CLOSE', hint: '', controller: closeController),
        const SizedBox(height: 20),
        _inputField(context: context, label: 'OPEN (OP)', hint: '', controller: opController),
      ],
    );
  }
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              // Pivot Point (Tengah)
              _levelRow('PP', data.pp, context.textPrimary, isPivot: true),
              _theDivider(context),
